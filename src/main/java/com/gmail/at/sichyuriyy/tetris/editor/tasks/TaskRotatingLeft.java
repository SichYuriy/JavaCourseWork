...
public class TaskRotatingLeft implements Task {
	...
	public void executeTask() {
		...
		if (selectedComponents.size() == 1) {
			...
			Command redo = new CommandRotateLeft(component);
			Command undo = new CommandRotateRight(component);
			...
			workspace.rotateLeft(composite.hashCode());
