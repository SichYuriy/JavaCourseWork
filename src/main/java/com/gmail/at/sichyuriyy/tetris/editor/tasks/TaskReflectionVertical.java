...
import com.gmail.at.sichyuriyy.tetris.editor.comands.CommandReflectVertical;
...
public class TaskReflectionVertical implements Task {
	...
	public void executeTask() {
		...
		if (selectedComponents.size() == 1) {
			...
			Command redo = new CommandReflectVertical(component);
			...
			workspace.reflectVertical(composite.hashCode());
			...
			Command reflectVertical = new CommandReflectVertical(composite);
			...
			redo.addCommand(reflectVertical);
